...
def benchmark():
    ...
    # 进阶算法cfgs
    # main_args.cfgs = [[[160, 32], [176, 672], [216, 608], [224, 1344], [248, 1248], [248, 1152]],
    # [[8, 96, 640], [120, 120, 1248], [224, 160, 1120], [176, 144, 576], [224, 256, 672], [216, 152, 1472]]]
    # m 4/16
    # main_args.cfgs = [[[216, 384], [248, 928], [240, 944], [232, 1056], [256, 1824], [232, 1744]],
    # [[8, 112, 1856], [104, 136, 1312], [216, 232, 1344], [192, 192, 1152], [200, 248, 1376], [208, 144, 1744]]]
    # m 16/64
    main_args.cfgs = [[[160, 64], [176, 704], [256, 832], [240, 1408], [208, 1984], [240, 2048]],
    [[16, 112, 896], [128, 128, 1408], [240, 160, 1088], [192, 144, 1728], [224, 144, 1408], [240, 144, 448]]]
    # 基础算法cfgs
    # main_args.cfgs = [[[152, 416], [232, 1408], [216, 1504], [232, 1248], [224, 1472], [248, 1344]],
    ...
    model.eval()
    # ===============================ptflops库计算方式
    flops, params = get_model_complexity_info(model, (3, 800, 1085), as_strings=True, print_per_layer_stat=True)
